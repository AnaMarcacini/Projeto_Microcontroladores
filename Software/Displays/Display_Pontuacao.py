...
def atualização():
    ...
    # Inicializa o display OLED I2C de 128x64
    display = SSD1306_I2C(128, 64, i2c0)
    display.fill_rect(10, 16, 29, 32, 1)     # desenha um retângulo sólido de 0,0 a 32,32, cor = 1
    display.fill_rect(74, 16, 128, 32, 1)     # desenha um retângulo sólido de 0,0 a 32,32, cor = 1
    display.show()
